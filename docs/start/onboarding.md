---
summary: "First-run onboarding flow for OpenNexus (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OpenNexus">
...
<Step title="CLI">
  ...
  The app can install the global `opennexus` CLI via npm/pnpm so terminal
