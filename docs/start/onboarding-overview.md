---
summary: "Overview of OpenNexus onboarding options and flows"
read_when:
...
OpenNexus supports multiple onboarding paths depending on where the Gateway runs
...
- [`opennexus onboard` command](/cli/onboard)

## macOS app onboarding

Use the OpenNexus app when you want a fully guided setup on macOS. Docs:
