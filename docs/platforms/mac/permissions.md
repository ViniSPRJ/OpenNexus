...
- Same path: run the app from a fixed location (for OpenNexus, `dist/OpenNexus.app`).
...
Workaround: move files into the OpenNexus workspace (`~/.opennexus/workspace`) if you want to avoid per-folder grants.
