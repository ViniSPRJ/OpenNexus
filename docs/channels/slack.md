...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure OpenNexus HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `opennexus pairing approve slack <code>`.
...
OpenNexus supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, OpenNexus falls back to normal delivery for remaining payloads.
