...
- Install via CLI: `opennexus plugins install @opennexus/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `opennexus plugins install ./extensions/zalo`
   - From npm (if published): `opennexus plugins install @opennexus/zalo`
...
- Approve via:
  - `opennexus pairing list zalo`
  - `opennexus pairing approve zalo <CODE>`
...
- Example: `opennexus message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `opennexus channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `opennexus logs --follow`
