...
read_when:
  - You want OpenNexus to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables OpenNexus to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`opennexus onboard`) and `opennexus channels add` list optional channel plugins.
...
```bash
opennexus plugins install @opennexus/nostr
```

Use a local checkout (dev workflows):

```bash
opennexus plugins install --link <path-to-opennexus>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "opennexus",
        "displayName": "OpenNexus",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "opennexus@example.com",
        "lud16": "opennexus@example.com"
      }
    }
  }
}
