...
OpenNexus treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.opennexus/settings/voicewake.json`

Shape:

```json
{ "triggers": ["opennexus", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
