...
read_when:
  ...
  - Wiring external systems into OpenNexus
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your OpenNexus config directory (typically `~/.opennexus/hooks/transforms`).
...
- `opennexus webhooks gmail setup` writes `hooks.gmail` config for `opennexus webhooks gmail run`.
