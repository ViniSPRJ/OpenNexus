...
read_when:
  - You are building a OpenNexus plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (opennexus.plugin.json)

Every plugin **must** ship a `opennexus.plugin.json` file in the **plugin root**.
OpenNexus uses this manifest to validate configuration **without executing plugin
