...
本指南总结了在 OpenNexus 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenNexus 状态目录下。默认为 `~/.opennexus`。如果设置了 `OPENNEXUS_STATE_DIR`，则使用该目录。
...
- https://docs.opennexus.ai/testing
- https://docs.opennexus.ai/start/getting-started
