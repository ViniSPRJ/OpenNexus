...
- 生成的 Swift 模型：`apps/macos/Sources/OpenNexusProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/opennexus/opennexus/main/dist/protocol.schema.json
