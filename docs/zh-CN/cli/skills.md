...
summary: "`opennexus skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
```bash
opennexus skills list
opennexus skills list --eligible
opennexus skills info <name>
opennexus skills check
```
