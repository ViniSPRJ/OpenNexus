...
Deploy OpenNexus on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/opennexus` — Control UI
...
- `OPENNEXUS_STATE_DIR=/data/.opennexus` (recommended)
- `OPENNEXUS_WORKSPACE_DIR=/data/workspace` (recommended)
- `OPENNEXUS_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your OpenNexus state + workspace so you can migrate to another host without losing config or memory.
