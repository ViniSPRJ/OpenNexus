---
summary: "Use NVIDIA's OpenAI-compatible API in OpenNexus"
read_when:
  - You want to use NVIDIA models in OpenNexus
...
opennexus onboard --auth-choice skip
opennexus models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
