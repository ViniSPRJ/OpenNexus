---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenNexus"
read_when:
  - You want Xiaomi MiMo models in OpenNexus
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenNexus uses
