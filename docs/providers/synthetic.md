---
summary: "Use Synthetic's Anthropic-compatible API in OpenNexus"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. OpenNexus registers it as the
...
Note: OpenNexus's Anthropic client appends `/v1` to the base URL, so use
