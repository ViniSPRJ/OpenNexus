...
You can point OpenNexus at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenNexus
...
- [Anthropic provider](/providers/anthropic) - Native OpenNexus integration with Claude setup-token or API keys
