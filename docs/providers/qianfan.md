---
summary: "Use Qianfan's unified API to access many models in OpenNexus"
read_when:
...
3. OpenNexus installed on your system
...
4. Copy the API key for use with OpenNexus

## CLI setup

```bash
opennexus onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OpenNexus Configuration](/gateway/configuration)
