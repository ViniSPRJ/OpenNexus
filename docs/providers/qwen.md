---
summary: "Use Qwen OAuth (free tier) in OpenNexus"
read_when:
  - You want to use Qwen with OpenNexus
...
If you already logged in with the Qwen Code CLI, OpenNexus will sync credentials
