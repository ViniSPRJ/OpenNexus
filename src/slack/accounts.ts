...
function mergeSlackAccountConfig(cfg: OpenNexusConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpenNexusConfig): ResolvedSlackAccount[] {
