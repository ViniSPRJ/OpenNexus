...
// Prefix for OpenNexus-generated action IDs to scope our handler
const OPENNEXUS_ACTION_PREFIX = "opennexus:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${OPENNEXUS_ACTION_PREFIX}`);

  // Handle OpenNexus modal submissions with callback_ids scoped by our prefix.
