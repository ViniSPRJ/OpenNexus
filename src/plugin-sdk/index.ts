...
export type { OpenNexusConfig } from "../config/config.js";
/** @deprecated Use OpenNexusConfig instead */
export type { OpenNexusConfig as ClawdbotConfig } from "../config/config.js";
