...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/opennexus/opennexus/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.OPENNEXUS_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.opennexus/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: OpenNexusConfig = {
    ...params.cfg,
