...
function resolveGatewayPort(cfg: OpenNexusConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: OpenNexusConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.OPENNEXUS_GATEWAY_PASSWORD?.trim() ||
