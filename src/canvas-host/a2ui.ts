...
export const A2UI_PATH = "/__opennexus__/a2ui";

export const CANVAS_HOST_PATH = "/__opennexus__/canvas";

export const CANVAS_WS_PATH = "/__opennexus__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.opennexusCanvasA2UIAction.postMessage(...)
  // - Android: window.opennexusCanvasA2UIAction.postMessage(...)
  const handlerNames = ["opennexusCanvasA2UIAction"];
  ...
  globalThis.OpenNexus = globalThis.OpenNexus ?? {};
  globalThis.OpenNexus.postMessage = postToNode;
  globalThis.OpenNexus.sendUserAction = sendUserAction;
  globalThis.opennexusPostMessage = postToNode;
  globalThis.opennexusSendUserAction = sendUserAction;
