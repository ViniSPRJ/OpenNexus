...
function cfg(input: Partial<OpenNexusConfig>): OpenNexusConfig {
  return input as OpenNexusConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<OpenNexusConfig["gateway"]>;
...
const DEFAULT_GATEWAY_ENV = {
  OPENNEXUS_GATEWAY_TOKEN: "env-token",
  OPENNEXUS_GATEWAY_PASSWORD: "env-password",
