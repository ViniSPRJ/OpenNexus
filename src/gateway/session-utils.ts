...
import { type OpenNexusConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenNexusConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenNexusConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenNexusConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenNexusConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OpenNexusConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: OpenNexusConfig): GatewaySessionsDefaults {
