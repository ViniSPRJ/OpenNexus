...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: OpenNexusConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: OpenNexusConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__opennexusMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__opennexusMcporterColdStartWarned;
  });
