...
function mergeDiscordAccountConfig(cfg: OpenNexusConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: OpenNexusConfig): ResolvedDiscordAccount[] {
