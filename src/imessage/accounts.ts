...
function mergeIMessageAccountConfig(cfg: OpenNexusConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OpenNexusConfig): ResolvedIMessageAccount[] {
