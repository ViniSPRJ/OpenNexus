...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("opennexus");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "opennexus");
