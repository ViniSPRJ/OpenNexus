...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.opennexus.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", OPENNEXUS_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.opennexus.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.opennexus.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when OPENNEXUS_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.opennexus.gateway.plist",
    },
    {
      name: "uses profile-specific label when OPENNEXUS_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", OPENNEXUS_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.opennexus.jbphoenix.plist",
    },
    {
      name: "prefers OPENNEXUS_LAUNCHD_LABEL over OPENNEXUS_PROFILE",
      env: {
        HOME: "/Users/test",
        OPENNEXUS_PROFILE: "jbphoenix",
        OPENNEXUS_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from OPENNEXUS_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        OPENNEXUS_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty OPENNEXUS_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        OPENNEXUS_PROFILE: "myprofile",
        OPENNEXUS_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.opennexus.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
