    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["opennexus channels list", "List configured channels and auth profiles."],
          ["opennexus channels status --probe", "Run channel status checks and probes."],
          [
            "opennexus channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["opennexus channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.opennexus.ai/cli/channels",
        )}\n`,
    );
