    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["opennexus directory self --channel slack", "Show the connected account identity."],
          [
            'opennexus directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["opennexus directory groups list --channel discord", "List available groups/channels."],
          [
            "opennexus directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.opennexus.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
