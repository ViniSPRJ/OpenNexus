...
export function listChannelMessageActions(cfg: OpenNexusConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OpenNexusConfig): boolean {
...
export function supportsChannelMessageCards(cfg: OpenNexusConfig): boolean {
