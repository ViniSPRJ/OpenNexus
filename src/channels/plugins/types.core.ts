...
export type ChannelAgentToolFactory = (params: { cfg?: OpenNexusConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpenNexusConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OpenNexusConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpenNexusConfig }) => boolean;
  supportsCards?: (params: { cfg: OpenNexusConfig }) => boolean;
