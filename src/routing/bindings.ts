...
export function listBindings(cfg: OpenNexusConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: OpenNexusConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OpenNexusConfig) {
