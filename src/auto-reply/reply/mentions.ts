...
function resolveMentionPatterns(cfg: OpenNexusConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpenNexusConfig | undefined, agentId?: string): RegExp[] {
