...
export function applyOpenrouterProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: OpenNexusConfig): OpenNexusConfig {
...
export function applyMoonshotConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: OpenNexusConfig): OpenNexusConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OpenNexusConfig): OpenNexusConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpenNexusConfig): OpenNexusConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: OpenNexusConfig): OpenNexusConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: OpenNexusConfig): OpenNexusConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: OpenNexusConfig): OpenNexusConfig {
...
export function applyQianfanProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: OpenNexusConfig): OpenNexusConfig {
