...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.opennexus.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("opennexus hooks list")}`,
      `  ${formatCliCommand("opennexus hooks enable <name>")}`,
      `  ${formatCliCommand("opennexus hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
