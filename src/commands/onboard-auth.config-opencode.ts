...
export function applyOpencodeZenProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
...
export function applyOpencodeZenConfig(cfg: OpenNexusConfig): OpenNexusConfig {
