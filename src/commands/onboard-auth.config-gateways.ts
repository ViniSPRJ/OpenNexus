...
export function applyVercelAiGatewayProviderConfig(cfg: OpenNexusConfig): OpenNexusConfig {
...
export function applyVercelAiGatewayConfig(cfg: OpenNexusConfig): OpenNexusConfig {
