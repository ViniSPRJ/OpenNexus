...
function isTelegramConfigured(cfg: OpenNexusConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: OpenNexusConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: OpenNexusConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: OpenNexusConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: OpenNexusConfig): boolean {
...
function isIMessageConfigured(cfg: OpenNexusConfig): boolean {
...
function isWhatsAppConfigured(cfg: OpenNexusConfig): boolean {
...
function isGenericChannelConfigured(cfg: OpenNexusConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: OpenNexusConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: OpenNexusConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: OpenNexusConfig, pluginId: string): boolean {
...
function isPluginDenied(cfg: OpenNexusConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: OpenNexusConfig, pluginId: string): OpenNexusConfig {
  const builtInChannelId = normalizeChatChannelId(pluginId);
  if (builtInChannelId) {
    const channels = cfg.channels as Record<string, unknown> | undefined;
