...
function resolveAvatarSource(cfg: OpenNexusConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenNexusConfig, agentId: string): AgentAvatarResolution {
