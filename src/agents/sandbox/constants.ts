...
export const DEFAULT_SANDBOX_IMAGE = "opennexus-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "opennexus-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "opennexus-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "opennexus-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "opennexus-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "opennexus-sandbox-browser";
