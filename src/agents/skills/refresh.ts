...
function resolveWatchPaths(workspaceDir: string, config?: OpenNexusConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OpenNexusConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenNexusConfig }) {
