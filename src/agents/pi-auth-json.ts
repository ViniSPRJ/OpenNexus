...
/**
 * Convert an OpenNexus auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * OpenNexus stores credentials in auth-profiles.json instead. This helper
