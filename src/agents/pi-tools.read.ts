...
function resolveAdaptiveReadMaxBytes(options?: OpenNexusReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOpenNexusReadTool(base, {
...
export function createOpenNexusReadTool(
  base: AnyAgentTool,
  options?: OpenNexusReadToolOptions,
): AnyAgentTool {
