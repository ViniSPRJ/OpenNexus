...
describe("buildSandboxCreateArgs", () => {
  ...
  it("includes hardening and resource flags", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "opennexus-sbx-test",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
      labels: { "opennexus.sandboxBrowser": "1" },
    });
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "opennexus.sandbox=1",
        "--label",
        "opennexus.sessionKey=main",
        "--label",
        "opennexus.createdAtMs=1700000000000",
        "--label",
