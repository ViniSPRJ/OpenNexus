...
const CLEANUP_STATE_KEY = Symbol.for("opennexus.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("opennexus.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("opennexus.sessionWriteLockWatchdogState");
