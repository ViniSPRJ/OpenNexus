...
function asOpenNexusConfig(config: Partial<OpenNexusConfig>): OpenNexusConfig {
  return config as OpenNexusConfig;
}

function createToolConfig() {
  return asOpenNexusConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: OpenNexusConfig = createToolConfig()) {
