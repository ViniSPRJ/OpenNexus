...
function resolveMemoryToolContext(options: { config?: OpenNexusConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: OpenNexusConfig): MemoryCitationsMode {
