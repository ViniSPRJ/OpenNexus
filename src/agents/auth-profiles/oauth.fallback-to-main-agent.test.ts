...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenNexusAgentDir() returns mainAgentDir
    process.env.OPENNEXUS_STATE_DIR = tmpDir;
    process.env.OPENNEXUS_AGENT_DIR = mainAgentDir;
