...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveOpenNexusAgentDir();
 ...
 * a hint.
 *
 * See: https://github.com/opennexus/opennexus/issues/17328
 */
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    "Ollama requires authentication to be registered as a provider. " +
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "opennexus configure". ' +
    "See: https://docs.opennexus.ai/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "opennexus configure". ' +
    "See: https://docs.opennexus.ai/providers/vllm",
};
