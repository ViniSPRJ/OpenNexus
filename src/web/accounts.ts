...
export function listWhatsAppAuthDirs(cfg: OpenNexusConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenNexusConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenNexusConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenNexusConfig): ResolvedWhatsAppAccount[] {
