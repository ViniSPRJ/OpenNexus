...
export type OpenNexusPluginConfigSchema = {
...
export type OpenNexusPluginToolContext = {
...
export type OpenNexusPluginToolFactory = (
  ctx: OpenNexusPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type OpenNexusPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type OpenNexusPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<OpenNexusConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type OpenNexusPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current OpenNexus configuration */
  config: OpenNexusConfig;
 ...
 */
export type OpenNexusPluginCommandDefinition = {
...
export type OpenNexusPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type OpenNexusPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type OpenNexusPluginCliContext = {
  program: Command;
  config: OpenNexusConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type OpenNexusPluginCliRegistrar = (ctx: OpenNexusPluginCliContext) => void | Promise<void>;

export type OpenNexusPluginServiceContext = {
  config: OpenNexusConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type OpenNexusPluginService = {
  id: string;
  start: (ctx: OpenNexusPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: OpenNexusPluginServiceContext) => void | Promise<void>;
};

export type OpenNexusPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type OpenNexusPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: OpenNexusPluginConfigSchema;
  register?: (api: OpenNexusPluginApi) => void | Promise<void>;
  activate?: (api: OpenNexusPluginApi) => void | Promise<void>;
};

export type OpenNexusPluginModule =
  | OpenNexusPluginDefinition
  | ((api: OpenNexusPluginApi) => void | Promise<void>);

export type OpenNexusPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | OpenNexusPluginToolFactory,
    opts?: OpenNexusPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: OpenNexusPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: OpenNexusPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: OpenNexusPluginHttpRouteHandler }) => void;
  registerChannel: (registration: OpenNexusPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: OpenNexusPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: OpenNexusPluginService) => void;
   ...
   */
  registerCommand: (command: OpenNexusPluginCommandDefinition) => void;
