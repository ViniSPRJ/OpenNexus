...
export const normalizePluginsConfig = (
  config?: OpenNexusConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: OpenNexusConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: OpenNexusConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: OpenNexusConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
