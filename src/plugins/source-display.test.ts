...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/opennexus/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/opennexus/extensions",
        global: "/Users/x/.opennexus/extensions",
        workspace: "/Users/x/ws/.opennexus/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.opennexus/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/opennexus/extensions",
        global: "/Users/x/.opennexus/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.opennexus/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/opennexus/extensions",
        global: "/Users/x/.opennexus/extensions",
