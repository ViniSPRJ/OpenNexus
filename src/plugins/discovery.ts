...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @opennexus/voice-call -> voice-call).
...
export function discoverOpenNexusPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".opennexus", "extensions")];
