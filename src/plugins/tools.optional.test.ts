...
const loadOpenNexusPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadOpenNexusPlugins: (params: unknown) => loadOpenNexusPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadOpenNexusPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadOpenNexusPluginsMock.mockClear();
  });
