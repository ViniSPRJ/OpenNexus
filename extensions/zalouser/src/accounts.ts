...
export function listZalouserAccountIds(cfg: OpenNexusConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenNexusConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenNexusConfig, accountId: string): ZalouserAccountConfig {
