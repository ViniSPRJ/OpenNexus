import type { OpenNexusConfig, PluginRuntime, ResolvedLineAccount } from "opennexus/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: OpenNexusConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: OpenNexusConfig; accountId: string }): Promise<{
