import type { LineChannelData, OpenNexusPluginApi, ReplyPayload } from "opennexus/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: OpenNexusPluginApi): void {
  api.registerCommand({
    name: "card",
