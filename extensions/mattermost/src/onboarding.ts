import type { ChannelOnboardingAdapter, OpenNexusConfig, WizardPrompter } from "opennexus/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.opennexus.ai/channels/mattermost",
    ].join("\n"),
