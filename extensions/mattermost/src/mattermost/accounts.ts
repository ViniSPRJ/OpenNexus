...
export function listMattermostAccountIds(cfg: OpenNexusConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenNexusConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenNexusConfig): ResolvedMattermostAccount[] {
