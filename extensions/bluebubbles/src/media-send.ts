...
import { resolveChannelMediaMaxBytes, type OpenNexusConfig } from "opennexus/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: OpenNexusConfig; accountId?: string }): string[] {
