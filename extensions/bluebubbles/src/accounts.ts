...
export function listBlueBubblesAccountIds(cfg: OpenNexusConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: OpenNexusConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: OpenNexusConfig): ResolvedBlueBubblesAccount[] {
