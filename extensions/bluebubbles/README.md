...
This directory contains the **BlueBubbles external channel plugin** for OpenNexus.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `opennexus/plugin-sdk` helpers.
