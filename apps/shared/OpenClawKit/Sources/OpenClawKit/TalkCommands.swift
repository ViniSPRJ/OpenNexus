...
public enum OpenNexusTalkCommand: String, Codable, Sendable {
...
public struct OpenNexusTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OpenNexusTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
