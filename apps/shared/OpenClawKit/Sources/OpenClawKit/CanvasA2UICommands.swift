...
public enum OpenNexusCanvasA2UICommand: String, Codable, Sendable {
...
public struct OpenNexusCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OpenNexusCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
