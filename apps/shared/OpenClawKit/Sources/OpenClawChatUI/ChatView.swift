...
@MainActor
public struct OpenNexusChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: OpenNexusChatViewModel
    ...
    public init(
        viewModel: OpenNexusChatViewModel,
    ...
    private var visibleMessages: [OpenNexusChatMessage] {
        let base: [OpenNexusChatMessage]
    ...
    private func mergeToolResults(in messages: [OpenNexusChatMessage]) -> [OpenNexusChatMessage] {
        ...
        for message in messages {
            ...
            let merged = OpenNexusChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: OpenNexusChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: OpenNexusChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: OpenNexusChatMessage) -> String {
