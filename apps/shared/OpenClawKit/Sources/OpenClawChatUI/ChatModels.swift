...
public typealias OpenNexusPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OpenNexusPlatformImage = UIImage
#endif

public struct OpenNexusChatUsageCost: Codable, Hashable, Sendable {
...
public struct OpenNexusChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OpenNexusChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OpenNexusChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OpenNexusChatMessageContent: Codable, Hashable, Sendable {
...
public struct OpenNexusChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OpenNexusChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OpenNexusChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OpenNexusChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OpenNexusChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OpenNexusChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OpenNexusChatMessageContent].self, forKey: .content) {
...
public struct OpenNexusChatHistoryPayload: Codable, Sendable {
...
public struct OpenNexusSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OpenNexusSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OpenNexusSessionPreviewItem]
}

public struct OpenNexusSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OpenNexusSessionPreviewEntry]

    public init(ts: Int, previews: [OpenNexusSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OpenNexusChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OpenNexusChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OpenNexusAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OpenNexusChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OpenNexusGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OpenNexusPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OpenNexusPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: OpenNexusPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct OpenNexusChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
