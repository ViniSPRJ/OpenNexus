...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.opennexus", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.opennexus", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OpenNexusChatMessage] = messages.compactMap { item in
