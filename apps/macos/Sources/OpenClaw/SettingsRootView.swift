...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .opennexusSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OpenNexusPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OpenNexusPaths.stateDirURL.path
...
extension Notification.Name {
    static let opennexusSelectSettingsTab = Notification.Name("opennexusSelectSettingsTab")
}
