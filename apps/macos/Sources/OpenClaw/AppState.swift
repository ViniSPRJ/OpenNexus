...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OpenNexusConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OpenNexusConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OpenNexusConfigFile.loadDict()
            ...
            OpenNexusConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/opennexus"
        state.remoteCliPath = ""
        return state
    }
}
