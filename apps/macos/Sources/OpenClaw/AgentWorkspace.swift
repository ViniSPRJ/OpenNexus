...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.opennexus", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OpenNexusConfigFile.defaultWorkspaceURL() }
