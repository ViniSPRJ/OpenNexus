...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/opennexus/opennexus") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/opennexus/opennexus")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://opennexus.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "OpenNexusBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenNexusBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OpenNexusGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenNexusGitCommit") as? String) ??
            "unknown"
    }
