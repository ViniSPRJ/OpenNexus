...
enum UIStrings {
    static let welcomeTitle = "Welcome to OpenNexus"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: OpenNexusOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: OpenNexusChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g opennexus@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OpenNexusChatViewModel(
