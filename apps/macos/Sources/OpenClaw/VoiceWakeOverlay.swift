...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.opennexus", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OpenNexus windows, but below the system’s pop-up menus.
