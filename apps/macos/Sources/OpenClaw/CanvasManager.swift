...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.opennexus", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("OpenNexus/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__opennexus__/a2ui/").absoluteString + "?platform=macos"
    }
