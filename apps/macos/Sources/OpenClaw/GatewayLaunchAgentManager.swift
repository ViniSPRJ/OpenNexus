...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.opennexus", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".opennexus/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.opennexusCommand(
            subcommand: "gateway",
