...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.opennexus.gateway"
    private static let nodeService = "ai.opennexus.node"
    private static let talkService = "ai.opennexus.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.opennexus.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.opennexus.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("opennexus-gateway.log")
    }
