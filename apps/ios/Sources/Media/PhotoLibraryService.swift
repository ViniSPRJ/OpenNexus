...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OpenNexusPhotosLatestParams) async throws -> OpenNexusPhotosLatestPayload {
        ...
        var results: [OpenNexusPhotoPayload] = []
        ...
        return OpenNexusPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OpenNexusPhotoPayload
    {
