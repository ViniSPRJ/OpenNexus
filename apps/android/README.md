## OpenNexus Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_opennexus-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm opennexus gateway --port 18789 --verbose
```
