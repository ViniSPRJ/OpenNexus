...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "opennexus", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for OpenNexus. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("OpenNexus Issue Label Audit");
