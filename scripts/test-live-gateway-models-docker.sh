...
docker run --rm -t \
  ...
  -e OPENNEXUS_LIVE_GATEWAY_MODELS="${OPENNEXUS_LIVE_GATEWAY_MODELS:-${CLAWDBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e OPENNEXUS_LIVE_GATEWAY_PROVIDERS="${OPENNEXUS_LIVE_GATEWAY_PROVIDERS:-${CLAWDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e OPENNEXUS_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${OPENNEXUS_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
