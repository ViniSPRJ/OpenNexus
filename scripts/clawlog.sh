...
show_usage() {
    cat << EOF
clawlog - OpenNexus Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View OpenNexus logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    OpenNexus logs flow through the macOS unified log (subsystem: ai.opennexus).
