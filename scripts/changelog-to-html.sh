...
if [[ -z "$version_content" ]]; then
  echo "<h2>OpenNexus $VERSION</h2>"
  echo "<p>Latest OpenNexus update.</p>"
  echo "<p><a href=\"https://github.com/opennexus/opennexus/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
