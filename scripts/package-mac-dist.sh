...
# Output:
# - dist/OpenNexus.app
# - dist/OpenNexus-<version>.zip
# - dist/OpenNexus-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.opennexus.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/OpenNexus.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OpenNexus-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenNexus-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenNexus-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OpenNexus-$VERSION.dSYM.zip"
